...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post usuarios_url, params: { usuario: { ap: @usuario.ap, ed: @usuario.ed, nom: @usuario.nom } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { ap: @usuario.ap, ed: @usuario.ed, nom: @usuario.nom } }
